package com.lbienit.library.weekview;

import static com.lbienit.library.weekview.WeekViewUtil.isSameDay;
import static com.lbienit.library.weekview.WeekViewUtil.today;
...
public class WeekView extends View {
    ...
    private Paint mRowStartPaint;
    private Paint mRowEndPaint;
    //sdv
    ...
    private void init() {
        ...
        //Set Row
        mRowStartPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mRowStartPaint.setColor(Color.BLACK);
        mRowEndPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mRowStartPaint.setColor(Color.BLACK);
    ...
    private void drawTimeColumnAndAxes(Canvas canvas) {
        ...
        // Draw the row start line for the header column.
    ...
    private void drawStartRow(Canvas canvas) {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber = leftDaysWithGaps + 1;
            ...
            canvas.drawRect(start, mHeaderHeight + mHeaderRowPadding * 2, start + 2, getHeight(), mRowStartPaint);
            canvas.drawRect(startPixel + mWidthPerDay, mHeaderHeight + mHeaderRowPadding * 2, startPixel + mWidthPerDay + 2, getHeight(), mRowStartPaint);
     ...
     * </p>
     * @param length Supported values are {@link com.lbienit.library.weekview.WeekView#LENGTH_SHORT} and
     * {@link com.lbienit.library.weekview.WeekView#LENGTH_LONG}.
     */
    @Deprecated
    ...
    public interface EventLongPressListener {
        /**
         * Similar to {@link com.lbienit.library.weekview.WeekView.EventClickListener} but with a long press.
         * @param event: event clicked.
         * @param eventRect: view containing the clicked event.
         */
    ...
    public interface EmptyViewLongPressListener {
        /**
         * Similar to {@link com.lbienit.library.weekview.WeekView.EmptyViewClickListener} but with long press.
